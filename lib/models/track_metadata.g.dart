...
void _trackMetadataSerialize(
  ...
  writer.writeLong(offsets[3], object.mixDurationMs);
  writer.writeLong(offsets[4], object.mixOutMs);
  writer.writeString(offsets[5], object.mixProfile);
}
...
TrackMetadata _trackMetadataDeserialize(
  ...
  object.id = id;
  object.mixDurationMs = reader.readLong(offsets[3]);
  object.mixOutMs = reader.readLongOrNull(offsets[4]);
  object.mixProfile = reader.readString(offsets[5]);
  return object;
}
